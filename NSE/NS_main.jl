...
include("my_path_to_folder/list_functions_NS_new.jl")

N = 3
K = 12

N0 = 8
K0 = 18 ; S = Chebyshev(N0)⊗SinFourier(K0,1)⊗SinFourier(K0,1)
...
N0 = 12 ;  S = Chebyshev(N0)⊗SinFourier(K0,1)⊗SinFourier(K0,1) # we add more chebyshev modes for a longer time step
h = interval(0.72)
